...
# Players
ffmpeg -framerate 5 -i images/$DIR/players/%d.png -crf 16 -vf "minterpolate='mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=5',hqdn3d" -pix_fmt yuv420p images/${DIR}_player_output.mp4 -y

ffmpeg -framerate 5 -i images/$DIR/players/%d.png -vf "palettegen" palette.png -y   
ffmpeg -framerate 5 -i images/$DIR/players/%d.png -i palette.png -lavfi "paletteuse" images/${DIR}_player_output.gif -y

# Tribes
ffmpeg -framerate 5 -i images/$DIR/tribes/%d.png -crf 16 -vf "minterpolate='mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=5',hqdn3d" -pix_fmt yuv420p images/${DIR}_tribe_output.mp4 -y

ffmpeg -framerate 5 -i images/$DIR/tribes/%d.png -vf "palettegen" palette.png -y
ffmpeg -framerate 5 -i images/$DIR/tribes/%d.png -i palette.png -lavfi "paletteuse" images/${DIR}_tribe_output.gif -y

# Tribes no zones of control
ffmpeg -framerate 5 -i images/$DIR/tribes/no_zoc/%d.png -crf 16 -vf "minterpolate='mi_mode=mci:mc_mode=aobmc:vsbmc=1:fps=5',hqdn3d" -pix_fmt yuv420p images/${DIR}_tribe_no_zoc_output.mp4 -y
